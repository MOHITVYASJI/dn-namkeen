  ...
  <div className={`${darkMode ? "dark" : ""}`}>
    <div className="min-h-screen bg-white text-gray-800 dark:bg-gray-900 dark:text-white transition duration-300">
      ...
      <header className="flex justify-between items-center px-6 py-4 shadow-md sticky top-0 bg-white z-50">
        <h1 className="text-2xl font-bold text-red-600">DN NAMKEEN</h1>
        <button
...
<section id="products" className="bg-gray-100 py-12 px-6">
  <h2 className="text-3xl font-bold text-center mb-10 text-red-700">Our Products</h2>
...
<section id="contact" className="py-12 px-6 bg-gray-100">
  ...
  <form action="https://formspree.io/f/mwkgyknw" method="POST" className="max-w-2xl mx-auto bg-white p-6 rounded-lg shadow-md">
    <label className="block mb-2 font-semibold">Name:</label>
    <input type="text" name="name" required className="w-full border px-4 py-2 mb-4 rounded" />

    <label className="block mb-2 font-semibold">Email:</label>
    <input type="email" name="email" required className="w-full border px-4 py-2 mb-4 rounded" />

    <label className="block mb-2 font-semibold">Message:</label>
    <textarea name="message" rows="4" required className="w-full border px-4 py-2 mb-4 rounded"></textarea>
